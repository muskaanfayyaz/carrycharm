document.addEventListener('DOMContentLoaded', () => {
  ...
  const products = [
      ...
      { id: "p6", name: "City Explorer", category: "Backpack", price: 4700, image: "public/zipper.jpeg", description: "Navigate the urban jungle with this versatile and durable backpack, designed for comfort and style." },
      { id: "p7", name: "Market Haul", category: "Tote", price: 2300, image: "public/sample.png", description: "The ideal reusable tote for your market runs, beach trips, or as an everyday carry-all." },
      ...
      { id: "p11", name: "Urban Carryall", category: "Backpack", price: 3800, image: "public/backpacks.jpeg", description: "A functional and fashionable backpack that's ready for anything your day throws at you." },
      { id: "p12", name: "Canvas Shopper", category: "Tote", price: 2100, image: "public/tote1.webp", description: "A simple yet sturdy canvas shopper tote, perfect for your daily errands." }
  ];
